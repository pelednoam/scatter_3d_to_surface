...
try:
    from preproc.utils import args_utils as au
except:
    su.add_preproc_to_import_path()
...
def install_mmvt_addon():
    ...
    module = 'sts_loader'
    sts_folder = su.get_sts_addon_dir()
    path = op.join(sts_folder, '{}.py'.format(module))
    ...
    addon_prefs.sts_folder = sts_folder
